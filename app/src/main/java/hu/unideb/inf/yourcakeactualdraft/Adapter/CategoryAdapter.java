...
import hu.unideb.inf.yourcakeactualdraft.Activity.ListCakesActivity;
import hu.unideb.inf.yourcakeactualdraft.Domain.Cakes;
import hu.unideb.inf.yourcakeactualdraft.Domain.Category;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.viewholder> {
    ...
    public void onBindViewHolder(@NonNull CategoryAdapter.viewholder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent=new Intent(context, ListCakesActivity.class);
