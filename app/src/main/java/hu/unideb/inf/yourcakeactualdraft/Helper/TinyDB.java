...
public class TinyDB {
    ...
    public ArrayList<Cakes> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Cakes> playerList =  new ArrayList<Cakes>();

        for(String jObjString : objStrings){
            Cakes player  = gson.fromJson(jObjString,  Cakes.class);
    ...
    public void putListObject(String key, ArrayList<Cakes> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Cakes player: playerList){
