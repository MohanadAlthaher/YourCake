package hu.unideb.inf.yourcakeactualdraft.Adapter;
...
import hu.unideb.inf.yourcakeactualdraft.Activity.DetailActivity;
...
public class CakeListAdapter extends RecyclerView.Adapter<CakeListAdapter.viewholder> {
    ArrayList<Cakes> items;
    Context context;

    public CakeListAdapter(ArrayList<Cakes> items) {
        this.items = items;
    }
    ...
    public CakeListAdapter.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View inflate = LayoutInflater.from(context).inflate(R.layout.viewholder_list_cake, parent, false);
